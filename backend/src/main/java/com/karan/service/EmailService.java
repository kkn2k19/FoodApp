...
import com.karan.model.Email;
import com.karan.repository.EmailRepo;
...
public class EmailService {
    ...
    public EmailService(EmailOTPSendService emailOTPSendService, EmailRepo emailRepository) {
